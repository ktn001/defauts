...
| :---- | :------: | :------: | :---- |
| Situation de départ: | ![Etat initial](/docs/images/defauts_initial.png "Etat initial") | ![Etat initial](/docs/images/defauts_initial_bw.png "Etat initial") | Pas de défaut, Les surveillances sont en état normal. |
